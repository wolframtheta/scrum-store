...
import { close, shareOutline, addCircleOutline } from 'ionicons/icons';
...
export class PwaInstallBannerComponent implements OnInit {
  ...
  constructor() {
    addIcons({ close, shareOutline, addCircleOutline });
  }

  ngOnInit() {
    // Don't show banner if running as native Capacitor app
